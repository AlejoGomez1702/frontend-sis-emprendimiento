...
@Component({
  selector: 'app-new2-maslow',
  templateUrl: './new2-maslow.component.html',
  styleUrls: ['./new2-maslow.component.css']
})
export class New2MaslowComponent implements OnInit 
{
  ...
  handleResponse(res)
  {
    ...
    if(code == 200) //OK
    {
      this.router.navigateByUrl('/dashboard/maslow/new3');
    }
    else
    {
